...
/**
 * This class represents the reading and writing of Square objects to and from a given file.
 * If an I/O error occurs while reading or writing from a file, an IOException is thrown.
...
public class SudokuFileIO {
     ...
     * @param data 2D array of Square objects that will be serialized and written to the given file.
